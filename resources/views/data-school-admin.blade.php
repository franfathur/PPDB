                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"
                                                data-bs-toggle="modal" data-bs-target=".delete{{  $x->NPSN }}"></i></a>
                                        <div class="modal fade delete{{  $x->NPSN }}" tabindex="-1" role="dialog"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center"><i class="fa fa-trash"></i><br>
                                                        Anda yakin ingin menghapus data ini?<br>{{ $x->NPSN }}
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-xl-4">
                                                            <label for="iduser">NPSN</label>
                                                            <input type="text" class="form-control" id="nama"
                                                                value="{{ $x->NPSN }}" placeholder="Enter ID NPSN"
                                                                name="id" readonly>
                                                        </div>
                                                        <div class="col-xl-8">
                                                            <label for="iduser">Nama Sekolah</label>

                                ...
                                <form action="save-jadwal" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" list="datalistOptionsJenis" id="exampleDataList"
                                            placeholder="Pilih Jenis Kegiatan" name="jenis" value="{{ old('jenis') }}">
                                        <datalist id="datalistOptionsJenis">
                                            <option value="Pendaftaran">Pendaftaran</option>
                                            <option value="Tes Potensi akademik dan Wawancara">Tes Potensi akademik dan
                                                Wawancara</option>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"
                                                data-bs-toggle="modal" data-bs-target=".delete{{  $x->id }}"></i></a>
                                        <div class="modal fade delete{{  $x->id }}" tabindex="-1" role="dialog"
                                            aria-hidden="true">
                                            ...
                                            <form action="update-jadwal/{{ $x->id }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nama"
                                                        ...
                                                        value="{{ $x->nama_kegiatan }}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="iduser">Jenis Kegiatan</label>

                                                    <input class="form-control" list="datalistOptionsJenis"
                                                        id="exampleDataList" placeholder="Pilih Jenis Kegiatan"
                                                        name="jenis" value="{{ $x->jenis_kegiatan }}">
                                                    <datalist id="datalistOptionsJenis">
                                                        <option value="Pendaftaran">Pendaftaran</option>
                                                        <option value="Tes Potensi akademik dan Wawancara">Tes Potensi
                                                            akademik dan Wawancara</option>
                                                        <option value="Pengumuman">Pengumuman</option>
                                                        <option value="Registrasi Ulang">Registrasi Ulang</option>
                                                    </datalist>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-xl-6 col-md-6">
                                                            ...
                                                            <input type="date" class="form-control" name="mulai"
                                                                value="{{$x->tgl_mulai }}" required>
                                                        </div>
                                                        <div class="col-lg-6 col-xl-6 col-md-6">
                                                            <label for="iduser">Tanggal Selesai</label>
                                                            <input type="date" class="form-control" name="selesai"
                                                                value="{{ $x->tgl_akhir }}" required>
                                                        </div>
                                                    </div>

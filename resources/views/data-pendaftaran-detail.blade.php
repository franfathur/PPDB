    ...
    <div class="col-xl-12">
        <div class="custom-accordion">
            ...
            <div class="row my-4">
                <div class="col">
                    <div class="text-end mt-2 mt-sm-0">
                        ...
                        <a href="../../verified-registration/{{$viewData->id_pendaftaran}}"><button type="button"
                                class="btn btn-primary">Verified</button></a>
                        @endif
                        <a href="../../card-registration/{{$viewData->id_pendaftaran}}"><button type="button"
            ...
            <div class="alert alert-success alert-dismissible fade show">
                ...
                <strong>Sukses!</strong> Data pendaftaranmu terkirim. Sebelum melakukan pembayaran, tunggu administrator
                memverifikasi datamu ya.

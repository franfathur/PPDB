                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <img class="avatar-lg rounded-circle img-thumbnail"
                                        src="{{ asset('sipenmaru/images/ava.png') }}" alt="" width="50px" />
                                    @endif
                                    @endif
                                    @endforeach
                                </a>
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="sidebar-user text-center">
                    ...
                    <a href="profile">
                        ...
                        @endif
                        @endforeach
                        <div class="badge-bottom"><span class="badge badge-primary">@if (auth()->user()->role
                                =="Administrator")
                                {{ auth()->user()->role }}
                                @else
                                Calon Siswa
                ...
                <div class="copyright">
                    <p><strong>PPDB SMEKDA </strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved
                    </p>
                    <p class="fs-12">Made with <span class="heart"></span> by Kelompok 1</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a target="_blank">Kelompok 1</a>
                </p>
            </div>
        </div>
        <!--**********************************

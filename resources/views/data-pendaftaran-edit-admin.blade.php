                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" value="{{ $viewData->nisn }}" class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" value="{{ $viewData->nik }}" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-4 mb-lg-0">
                                        ...
                                        <input type="text" value="{{ $viewData->temoat_lahir }}" class="form-control"
                                            id="basicpill" name="tempatlahir" placeholder="Masukkan Tempat Lahir"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-4 mb-lg-0">
                                        ...
                                        <input type="date" value="{{ $viewData->tanggal_lahir }}" class="form-control"
                                            id="basicpill" name="tanggallahir" placeholder="Masukkan Tanggal Lahir"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" value="{{ $viewData->no_hp }}" class="form-control"
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <p class="text-muted text-truncate mb-0">Pilihan program keahlian </p>
                                </div>
                                <div class="flex-shrink-0"> <i
                                        class="mdi mdi-chevron-up accor-down-icon font-size-24"></i> </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input class="form-control" value="{{ $viewData->pil1 }}"
                                            list="datalistOptionsProdi" id="exampleDataList"
                                            placeholder="Cari Program Keahlian..." name="pil1" value="{{ old('pil1') }}"
                                            autocomplete='off'>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input class="form-control" value="{{ $viewData->pil2 }}"
                                            list="datalistOptionsProdi" id="exampleDataList"
                                            placeholder="Type to search..." name="pil2" value="{{ old('pil2') }}"
                                            autocomplete='off'>
                                        <datalist id="datalistOptionsProdi">
                                            @foreach ($viewProdi as $z)
                                            <option value="{{ $z->id_prodi }}">{{ $z->nama_prodi }}</option>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="text" value="{{ $viewData->nama_ayah }}" class="form-control"
                                            id="personal-data-name" name="ayah" placeholder="Masukkan Nama Ayah"
                                            value="{{ old('ayah') }}">
                                        @error('ayah')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" value="{{ $viewData->nohp_ayah }}" class="form-control"
                                            id="personal-data-no" name="noayah" placeholder="Enter Father's Mobile"
                                            value="{{ old('noayah') }}">
                                        @error('pekerjaanayah')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" value="{{ $viewData->tanggungan }}" class="form-control"
                                            id="personal-data-nik" name="tanggungan"
                                            placeholder="Masukkan Jumlah Tangggungan" value="{{ old('tanggungan') }}">
                                        @error('tanggungan')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <p class="text-muted text-truncate mb-0">Sekolah asal, nilai
                                        raport dan ijazah</p>
                                </div>
                                <div class="flex-shrink-0"> <i
                                        class="mdi mdi-chevron-up accor-down-icon font-size-24"></i> </div>
                    ...
                    <div id="school-data" class="collapse">
                        <div class="p-4 border-top">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input class="form-control" value="{{ $viewData->id_Sekolah }}"
                                            list="datalistOptionsSekolah" id="exampleDataList"
                                            placeholder="Cari NPSN sekolah...." name="id_sekolah"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data">Ijazah <small>(jika sudah
                                                lulus)</small></label>
                                        <div class="input-group">
                                            <span class="input-group-text">Upload</span>
                                            <div class="form-file">

                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="items">
                                            <h4 class="fs-20 font-w700 mb-4">Data Progress <br> Penerimaan Siswa
                                                Baru</h4>
                                    ...
                                    <div class="col-xl-6 redial col-sm-6">
                                        ...
                                        <span class="text-center d-block fs-18 font-w600">Sedang berlangsung
                                            <small class="text-success"><span id="progressnya">{{ $hslpersenanbaru
                                                    }}</span>
                                                %</small></span>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body d-flex px-4 pb-0 justify-content-between">
                                        ...
                                        <div id="columnChart">
                                            ...
                                            <span id="prodi{{ $no }}" style="color:transparent" aria-disabled>{{
                                                $x->jmldaftarprodi }}</span>
                                            @php
                                            $no++;
                                            @endphp
                                            @endforeach
...
<div class="row page-titles" style="border-radius: 0%">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">PPDB SMEKDA</a></li>
    </ol>
</div>
<div class="row">
    <div class="col-xl-7">
                ...
                <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/banner (1).jpg') }}"
                                alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/banner (2).jpg') }}"
                                alt="Second slide">
                        </div>
                    </div>
...
<div class="row">
                ...
                <div class="new-arrivals-img-contnent">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <a href="ecom-product-detail.html">
                            <h4 style="color: whitesmoke">Administrasi Perkantoran</h4>
                        </a>
                        <p>3 Tahun</p>
                    </div>
                </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6" style="padding: 0px">
        <div class="card" style="border-radius: 0%">
            <div class="new-arrival-product">
                <div class="new-arrivals-img-contnent">
                    <img class="img-fluid" src="{{ asset('sipenmaru/images/dkv.jpg') }}" alt="">
                    <div class="carousel-caption d-none d-md-block">
                        <a href="ecom-product-detail.html">
                            <h4 style="color: whitesmoke">Desain Komunikasi Visual</h4>
                        </a>
                        <p>3 Tahun</p>
                    </div>
                </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6" style="padding: 0px">
        <div class="card" style="border-radius: 0%">
            <div class="new-arrival-product">
                <div class="new-arrivals-img-contnent">
                    <img class="img-fluid" src="{{ asset('sipenmaru/images/tkj.jpg') }}" alt="">
                    <div class="carousel-caption d-none d-md-block">
                        <a href="ecom-product-detail.html">
                            <h4 style="color: whitesmoke">Teknik Komputer dan Jaringan</h4>
                        </a>
                        <p>3 Tahun</p>
                    </div>
                </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6" style="padding: 0px">
        <div class="card" style="border-radius: 0%">
            <div class="new-arrival-product">
                <div class="new-arrivals-img-contnent">
                    <img class="img-fluid" src="{{ asset('sipenmaru/images/akt.jpeg') }}" alt="">
                    <div class="carousel-caption d-none d-md-block">
                        <a href="ecom-product-detail.html">
                            <h4 style="color: whitesmoke">Akuntansi</h4>
                        </a>
                        <p>3 tahun</p>
                    </div>
                </div>
                            ...
                            <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-5 ">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade show active" id="first">
                                        <img class="img-fluid" src="{{ asset('sipenmaru/images/brosur1.jpeg') }}"
                                            alt="">
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="second">
                                        <img class="img-fluid" src="{{ asset('sipenmaru/images/brosur2.jpeg') }}"
                                            alt="">
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav slide-item-list mt-3" role="tablist">
                                        <li role="presentation" class="show">
                                            <a href="#first" role="tab" data-bs-toggle="tab">
                                                <img class="img-fluid"
                                                    src="{{ asset('sipenmaru/images/brosur1.jpeg') }}" alt=""
                                                    width="50">
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#second" role="tab" data-bs-toggle="tab"><img class="img-fluid"
                                                    src="{{ asset('sipenmaru/images/brosur2.jp3g') }}" alt=""
                                                    width="50"></a>
                                        </li>
                                    </ul>
                                </div>

                            ...
                            <div class="modal-body">
                                <form action="save-user" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="nama" placeholder="Masukkan Email"
                                            name="email" required>
                                    </div>
                                    <div class="form-group">
                    ...
                    <table id="example3" class="display" style="min-width: 845px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if ($x->Foto != null)
                                    <img class=" rounded-circle img-thumbnail" src="{{ url('/' . $x->Foto) }}" alt=""
                                        width="45px" />
                                    @else
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a class="btn btn-primary shadow btn-xs sharp me-1" title="Edit"
                                            href="edit-user/{{ $x->Id_user }}"><i class="fa fa-pencil-alt"></i></a>
                                        <a href="delete-user/{{ $x->Id_user }}"
                                            class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                        <div class="modal fade delete{{ $x->Id_user }}" tabindex="-1" role="dialog"
                                            aria-hidden="true">

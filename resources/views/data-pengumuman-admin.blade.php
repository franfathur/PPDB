                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="save-announcement" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="iduser">Program Keahlian Penerima </label>
                    ...
                    <table id="example3" class="display" style="min-width: 845px">
                        <thead>
                            <tr>
                                ...
                                <th>Hasil</th>
                                <th>Program Keahlian Penerima</th>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-primary shadow btn-xs sharp me-1" title="Edit"
                                            data-bs-toggle="modal" data-bs-target=".edit{{ $x->id_pengumuman }}"><i
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center"><i class="fa fa-trash"></i><br>
                                                        Apakah anda yakin ingn menghapus data ini? <br>{{
                                                        $x->id_pengumuman }}
                                                    </div>
                                            ...
                                            <form action="update-announcement/{{ $x->id_pengumuman }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="default-select form-control wide" title="Recipient"
                                                        name="prodi" required>
                                                        <option value="{{ $x->prodi_penerima }}" selected>{{
                                                            $x->prodi_penerima }}</option>
                                                        @foreach ($viewProdi as $z)
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            ...
                                                            <input type="number" class="form-control" id="nama"
                                                                value="{{ $x->nilai_interview }}" name="interview"
                                                                required>
                                                        </div>
                                                        <div class="col-xl-6">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        ...
                        <h5 class="card-title">Pengumuman Seleksi Penerimaan Siswa Baru </h5> <br>

        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div class="mb-3">
                        <h4 class="fs-24 font-w700">Pengumuman <br>Pendaftaran Siswa Baru</h4>
                    ...
                    <div class="mb-3">
                        <div class="d-flex align-items-center mb-4 pb-3 justify-content-end flex-wrap">
                            <div class="me-3">
                                <h4 class="fs-18 font-w600">PPDB SMEKDA</h4>
                                <span>Jalan Veteran No 5 <br>Kota Kediri 64114 Indonesia</span>
                            </div>
                            <div class="me-3">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody border="5">
                                ...
                                <tr border="5">
                                    ...
                                    <td colspan="4"><img src="{{ url('/'.$viewIdPendaftaran->pas_foto) }}" alt=""
                                            width="180px" height="240"></td>
                                <tr>
                                ...
                                <tr border="5">
                                    <th colspan="3" scope="row">
                                        ...
                                        @if($x->hasil_seleksi == 'TIDAK LULUS' && $x->id_pendaftaran==
                                        $viewIdPendaftaran->id_pendaftaran)
                                        <div class="alert alert-danger solid alert-rounded" style="border-radius: 0%">
                                            ...
                                            Siswa Baru, Silahkan coba kembali, Jangan Menyerah Ya!
                                        </div>
                                        @elseif ($x->hasil_seleksi == 'LULUS' && $x->id_pendaftaran==
                                        $viewIdPendaftaran->id_pendaftaran)
                                        ...
                                        <div class="alert alert-outline-success alert-dismissible fade show"
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <th scope="row">Program Keahlian Penerima</th>
                                                    <td>

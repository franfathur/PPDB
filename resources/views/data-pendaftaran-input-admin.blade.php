                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" id="personal-data-nisn" name="nisn"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" id="personal-data-nik" name="nik"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="basicpill" name="nama"
                                            placeholder="Masukkan Nama Lengkap" value="{{ $x->Nama }}">
                                        @else
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-4 mb-lg-0">
                                        ...
                                        <input type="text" class="form-control" id="basicpill" name="tempatlahir"
                                            placeholder="Masukkan Tempat Lahir" value="{{ $x->Tempat_lahir }}">
                                        @else
                                        <input type="text" class="form-control" id="basicpill" name="tempatlahir"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-4 mb-lg-0">
                                        ...
                                        <input type="date" class="form-control" id="basicpill" name="tanggallahir"
                                            placeholder="Masukkan Tanggal Lahir" value="{{ $x->Tanggal_lahir }}">
                                        @else
                                        <input type="date" class="form-control" id="basicpill" name="tanggallahir"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="email" class="form-control" id="personal-data-nisn" name="email"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" id="basicpill" name="nohp"
                                            placeholder="Masukkan Tanggal Lahir" value="{{ $x->No_Hp }}">
                                        @else
                                        <input type="number" class="form-control" id="basicpill" name="nohp"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input class="form-control" list="datalistOptionsProdi" id="exampleDataList"
                                            placeholder="Pilih program Keahlian" name="pil1" value="{{ old('pil1') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input class="form-control" list="datalistOptionsProdi" id="exampleDataList"
                                            placeholder="Pilih program Keahlian" name="pil2" value="{{ old('pil2') }}">
                                        <datalist id="datalistOptionsProdi">
                                            @foreach ($viewProdi as $z)
                                            <option value="{{ $z->id_prodi }}">{{ $z->nama_prodi }}
                                            </option>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" id="personal-data-no" name="noayah"
                                            placeholder="Masukkan Telepon Ayah" value="{{ old('noayah') }}">
                                        @error('pekerjaanayah')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="personal-data-name" name="ibu"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-gender">Pekerjaan
                                            Ibu</label>
                                        <input class="form-control" list="datalistOptionsOccupation"
                                            id="exampleDataList" placeholder="Cari Pekerjaan Ibu.." name="pekerjaanibu"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" id="personal-data-no" name="noibu"
                                            placeholder="Masukkan Telepon Ibu" value="{{ old('noibu') }}">
                                        @error('noibu')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                ...
                <div class="card">
                    ...
                    <div id="school-data" class="collapse">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3 mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">Upload</span>
                                        <div class="form-file">
                                            <input type="file" class="form-file-input form-control" name="ftprestasi"
                                                value="{{ old('ftprestasi') }}">
                                        </div>
                                    </div>
                                    @error('ftprestasi')
                                    <div class="alert alert-warning" role="alert">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3 mb-4">
                                    <label class="form-label" for="personal-data">Ijazah <small>(jika
                                            ada)</small></label>
                                    <div class="input-group">
                                        <span class="input-group-text">Upload</span>
                                        <div class="form-file">

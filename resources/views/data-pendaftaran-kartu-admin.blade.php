                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-lg-6">
                            <center>
                                ...
                                <h5 style="margin-top: -0.5rem"> <strong class="d-block">PENERIMAAN SISWA BARU</strong>
                                    </h4>
                                    <h4 style="margin-top: -0.5rem"><strong class="d-block">SMK NEGERI 2 KEDIRI
                                        </strong></h3>
                                        <p style="margin-top: -0.5rem"><strong class="d-block">JL. VETERAN NO. 5 KEDIRI
                                                & JL. MONGINSIDI 36 KEDIRI, Bandar Lor, Kec. Mojoroto, Kota Kediri, Jawa
                                                Timur <br> 64114</strong></p>
                            </center>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4" style="border-top: 2px solid black!important; margin-top:-2.5rem;">
                        ...
                        <div class="mb-4">
                            ...
                            <h5 style="text-indent: 0.5in;text-align: justify;">Saya yang menyatakan bahwa data yang
                                saya isikan dalam formulir pendaftaran penerimaan siswa baru SMK NEGERI 2 KEDIRI 2022

...
<ul class="metismenu" id="menu">
    ...
    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
        ...
        <ul aria-expanded="false">
            ...
            <li><a href="data-studyProgram">Program Keahlian</a></li>
        </ul>
    </li>
    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            ...
                            <div class="card-body tryal row">
                                <div class="col-xl-7 col-sm-6">
                                    <h2>Selamat Datang, @auth
                                        {{ auth()->user()->name }}
                                        @endauth</h2>
                                    <span>Terus pantau kegiatan penerimaan siswa baru SMK Negeri 2 Kediri</span>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex me-5">
                                            <div class="mt-2">
                                                <svg width="13" height="13" viewbox="0 0 13 13" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="6.5" cy="6.5" r="6.5" fill="#83DBE0">
                                                    </circle>
                                                </svg>
                                            </div>
                                            <div class="ms-3">
                                        ...
                                        <div class="d-flex">
                                            <div class="mt-2">
                                                <svg width="13" height="13" viewbox="0 0 13 13" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="6.5" cy="6.5" r="6.5" fill="#9FC3F9">
                                                    </circle>
                                                </svg>
                                        ...
                                        <div class="modal fade delete{{ $x->id_pendaftaran }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center"><i class="fa fa-trash"></i><br>
                                                        Anda yakin ingin
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="delete-registration/{{ $x->id_pendaftaran }}">
...
<div class="row">
    <div class="col-lg-3">
        <div class="card card-body bg-primary">
            <h4 class="fs-20 font-w700" style="color: whitesmoke">Administrasi <br> Perkantoran</h4>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="card card-body" style="background-color: rgb(159, 195, 249)">
            <h4 class="fs-20 font-w700" style="color: whitesmoke">Desain <br> Komunikasi Visual</h4>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="card card-body" style="background-color: rgb(131, 219, 224)">
            <h4 class="fs-20 font-w700" style="color: whitesmoke">Teknik Komputer <br> dan Jaringan</h4>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="card card-body" style="background-color: rgb(255, 174, 0)">
            <h4 class="fs-20 font-w700" style="color: whitesmoke">Akutansi</h4>
        </div>
    </div>
</div>
<div class="row">
                ...
                <div class="row">
                    <div class="col-xl-4 col-sm-4">
                        <div class="card-body owl-carousel card-slider">
                            <div class="items">
                                <h3 class="fs-20 font-w700 mb-4">Sistem Pembelajaran</h3>
                                <span class="fs-18 font-w400">
                                    Keterampilan lebih terasah dengan 60 – 70% pembelajaran secara praktik. </span>
                            </div>
                            <div class="items">
                            ...
                            <div class="items">
                                <h3 class="fs-20 font-w700 mb-4">Biaya Pembelajaran</h3>
                                <span class="fs-18 font-w400">Biaya Pembelajaran yang dapat diangsur dan berbagai
            ...
            <div class="accordion accordion-header-shadow accordion-rounded" id="accordion-ten">
                <div class="accordion-item">
                    <div class="accordion-header  rounded-lg" id="accord-10One" data-bs-toggle="collapse"
                        ...
                        <span class="accordion-header-text">Sudah kenal dengan SMK Negeri 2 Kediri</span>
                    ...
                    <div id="collapse10One" class="collapse accordion__body show" aria-labelledby="accord-10One"
                        ...
                        <div class="accordion-body-text">
                            <span class="fs-16 font-w400">
                                <h5 style="text-indent: 0.5in;text-align: justify;">SMK Negeri 2 Kediri adalah Sekolah
                                    luas yang dirancang dengan fasilitas yang menyeluruh untuk pendidikan yang
                                    berkualitas dan menghasilkan sumber daya manusia bidang teknik dan Bisnis Manajemen
                                    berkualitas tinggi untuk industri. SMK Negeri 2 Kediri memiliki visi untuk menjadi
                                    lembaga pendidikan yang berkeahlian tinggi.</h5>
                                <h5 style="text-indent: 0.5in;text-align: justify;"> SMK Negeri 2 Kediri juga didukung
                                    oleh Pemerintah Daerah dan perusahaan melalui program beasiswa bagi siswa
                                    berprestasi untuk melanjutkan studi. SMK Negeri 2 Kediri juga bekerja sama dengan
                                    berbagai perusahaan lokal dan internasional dalam menyediakan pendidikan keahlian
                                    berkualitas tinggi.</h5>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <div class="accordion-header collapsed rounded-lg" id="accord-10Three" data-bs-toggle="collapse"
                        data-bs-target="#collapse10Three" aria-controls="collapse9Three" aria-expanded="true"
                        role="button">
                        <span class="accordion-header-icon"></span>

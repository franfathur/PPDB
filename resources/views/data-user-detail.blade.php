                        ...
                        <div class="tab-content">
                            <div id="about-me" class="tab-pane fade active show">
                                <div class="profile-personal-info">
                                    <br>
                                    @if ($viewData->No_Hp == null || $viewData->Tempat_lahir == null ||
                                    $viewData->Gender == null || $viewData->Alamat == null)
                            ...
                            <div id="profile-settings" class="tab-pane fade">
                                <div class="pt-3">
                                    <div class="settings-form">
                                        ...
                                        <form action="../update-user/{{ $viewData->Id_user }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" value="{{ $viewData->No_Hp }}"
                                                        value="{{ old('hp') }}" class="form-control" name="hp">
                                                    @error('hp')
                                                    <div class="alert alert-warning" role="alert">
                                                        <strong>Warning!</strong>
                                                        {{ $message }}

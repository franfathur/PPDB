            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div>
                        ...
                        @if ($x->Foto != null)
                        <img class="avatar-lg rounded-circle img-thumbnail" src="{{ url('/' . $x->Foto) }}" alt=""
                            width="100px" />
                        @else
                    ...
                    <div class="mt-4">
                        <a href="mailto:{{ auth()->user()->email }}"><button type="button"
                        ...
                        <div class="tab-content">
                            <div id="about-me" class="tab-pane fade active show">
                                <div class="profile-personal-info">
                                    ...
                                    @if (auth()->user()->email == $x->Email)
                                    <br>
                                    @if ($x->No_Hp == null || $x->Tempat_lahir == null || $x->Gender == null ||
                                    $x->Alamat == null)
                                        ...
                                        <form action="edit-profile" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="hidden" name="pathFoto" class="form-control-file"
                                                        value="{{ $x->Foto }}">
                                                    <img class="avatar-lg rounded-circle img-thumbnail"
                                                        src="{{ url('/' . $x->foto) }}" width="75px" height="auto"
                                                        alt="">
                                                    @error('foto')
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" value="{{ $x->Tempat_lahir }}"
                                                        value="{{ old('tempat') }}" class="form-control" name="tempat">
                                                    @error('tempat')
                                                    <div class="alert alert-warning" role="alert">
                                                        <strong>Warning!</strong>
                                                        {{ $message }}
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="date" value="{{ $x->Tanggal_lahir }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Sosial Media
                                                        Instagram</label>
                                                    <input type="text" value="{{ $x->Instagram }}"
                                                        value="{{ old('ig') }}" class="form-control" name="ig">
                                                    @error('ig')
                                                    <div class="alert alert-warning" role="alert">
                                                        <strong>Warning!</strong>
                                                        {{ $message }}
                            ...
                            <div id="acc-settings" class="tab-pane fade">
                                <div class="pt-3">
                                    <div class="settings-form">
                                        ...
                                        <form action="edit-pw/{{ auth()->user()->id }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="id_user" class="form-control-file"
                                                value="{{ $x->Id_user }}">
                                            <input type="hidden" name="id" class="form-control-file"
                                                value="{{ auth()->user()->id }}">
                                            <!-- <div class="row">
